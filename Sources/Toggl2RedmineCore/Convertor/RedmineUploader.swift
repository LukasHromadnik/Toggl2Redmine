...
public protocol RedmineUploading {
    func uploadEntries(_ redmineEntries: [String: [RedmineEntry]], sortedTogglEntries: [String: [TogglEntry]])
}

public final class RedmineUploader: RedmineUploading {
    public static var shared = RedmineUploader()
    
    public func uploadEntries(_ redmineEntries: [String: [RedmineEntry]], sortedTogglEntries: [String: [TogglEntry]]) {
